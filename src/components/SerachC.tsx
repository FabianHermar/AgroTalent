export default function SearchC () {
  return (
    <div className="z-40 w-full flex justify-center origin-bottom">
      <div
        className="flex relative w-full items-center justify-center min-h-12 gap-2 bg-zinc-900 shadow-lg rounded-3xl sm:shadow-black/40 px-2 transition-all duration-300 z-10 max-w-[710px]">
        {/* <div className="items-center justify-center hidden rounded-l-full sm:flex"> <img alt="Avatar" width="32" height="32"
          className="relative flex rounded-full shrink-0"
          src="https://vercel.com/api/www/avatar/RFvdGIGEGC3eaNH4V1BBDLSw?s=64" />
        </div> */}
        <div className="relative flex items-center self-end flex-1 w-full min-w-0 pl-2">
          <form className="w-full h-full">
            <div className="relative w-full flex-1 flex items-center gap-2 transition-all duration-300 ">
              <div className="relative flex flex-1 justify-between min-w-0 self-start w-full min-h-[3rem] items-center">
                <input placeholder='Cargo' type="text" className="min-h-[1.5rem] sm:border-r pl-1 border-zinc-600 flex-[1_0_50%] disabled:opacity-80 text-white text-sm bg-transparent shadow-none resize-none outline-none ring-0 disabled:bg-transparent selection:bg-teal-300 selection:text-black placeholder:text-zinc-400 [scroll-padding-block:0.75rem] pr-2 leading-relaxed py-2.5 sm:py-3 w-full" />
                <span className="pl-2" />
                <input placeholder='Localidad' type="text" className="min-h-[1.5rem] flex-[1_0_50%] disabled:opacity-80 text-white text-sm bg-transparent border-0 shadow-none resize-none outline-none ring-0 disabled:bg-transparent selection:bg-teal-300 selection:text-black placeholder:text-zinc-400 [scroll-padding-block:0.75rem] pr-2 leading-relaxed py-2.5 sm:py-3 w-full" />
              </div>
              <div className="flex flex-row-reverse">
                <div className="" data-state="closed">
                  <button
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" className="w-6 h-6"
                      aria-hidden="true">
                      <path
