					...
					<div className='max-w-xl lg:max-w-3xl relative'>
						...
						<form action='#' className='mt-8 grid grid-cols-6 gap-6'>
							...
							<div className='col-span-6'>
								<p className='mt-4 text-sm font-GilroyRegular text-gray-500'>
									...
									<a
										href='#'
										className='text-gray-700 underline font-GilroyMedium'
									>
										Recupérala aquí
									</a>
								</p>
							...
							<div className='col-span-6 sm:flex sm:items-center sm:gap-4 pt-10'>
								...
								<p className='mt-4 text-sm text-gray-500 sm:mt-0 font-GilroyRegular'>
									...
									<a
										href='#'
										className='group relative inline-flex items-center justify-center rounded-md text-black ml-2'
									>
										<span className='underline font-GilroySemibold'>
											Únete ahora
										</span>
						...
						<div className='pt-32'>
							<p className='text-gray-400 font-GilroyRegular text-xs'>
								...
								, aceptas las
								<a href='#' className='font-GilroySemibold hover:underline'>
									{' '}
									Condiciones de uso
								</a>
								,
